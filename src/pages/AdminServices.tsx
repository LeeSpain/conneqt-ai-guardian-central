...
const setMeta = () => {
  document.title = 'Platform Products | Admin Dashboard';
  const desc = 'Manage platform products: enable/disable and edit labels/descriptions/pricing for Builder & Homepage.';
      ...
      <AdminContainer>
        <div className="space-y-6">
          <header className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Platform Products</h1>
              <p className="text-muted-foreground mt-2">Toggle visibility and customize labels/descriptions/pricing. Changes apply to the Builder and homepage.</p>
