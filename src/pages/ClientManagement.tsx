        ...
        <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <Tabs defaultValue="clients" className="w-full">
            ...
            <TabsContent value="tickets" className="space-y-6">
                        ...
                        {tickets.map((ticket) => {
                          ...
                          return (
                            <TableRow key={ticket.id}>
                              <TableCell>#{ticket.id}</TableCell>
                              <TableCell>
                                {client ? client.name : `Client #${ticket.clientId}`}
                              </TableCell>
              ...
              {/* Ticket Management Features - Pro/Enterprise only */}
              {subscriptionTier !== 'starter' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <Button variant="outline" className="w-full justify-start text-left h-auto py-3">
                          <div>
                            <p className="font-medium">Account Access Help</p>
                            <p className="text-xs text-muted-foreground mt-1">
                              Instructions for resetting passwords and accessing accounts
                            </p>
                          </div>
                        </Button>
                        <Button variant="outline" className="w-full justify-start text-left h-auto py-3">
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                              Information about payment methods and invoice schedules
                            </p>
                          </div>
                        </Button>
                        <Button variant="outline" className="w-full justify-start text-left h-auto py-3">
                        ...
                        {subscriptionTier === 'enterprise' && (
                          <Button variant="outline" className="w-full justify-start text-left h-auto py-3">
                            <div>
                              <p className="font-medium">Custom AI Response</p>
                              <p className="text-xs text-muted-foreground mt-1">
                                Generate custom AI responses based on client history
                              </p>
                            </div>
                          </Button>
                        )}
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Performance metrics for your support team
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="flex justify-between mb-1 text-sm">
                            ...
                            <span>{tickets.filter(t => t.status === 'Open').length} of {tickets.length}</span>
                          </div>
                          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div 
                        ...
                        <div>
                          <div className="flex justify-between mb-1 text-sm">
                            ...
                            <span>{tickets.filter(t => t.priority === 'Critical').length} tickets</span>
                          </div>
                          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div 
                              className="bg-red-500 h-full rounded-full" 
                              style={{ width: `${(tickets.filter(t => t.priority === 'Critical').length / tickets.length) * 100}%` }}
                            ></div>
                          </div>
                        </div>
                      </div>
              ...
              {subscriptionTier === 'starter' && (
                <Card className="bg-blue-50 border-blue-100">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Enhance your ticket handling capabilities
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <p>
                      The Starter plan includes basic ticket viewing and creation. Upgrade to Professional or Enterprise for:
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2">
                        <Check className="h-5 w-5 text-green-600" />
                        <span>Custom ticket workflows and automation</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="h-5 w-5 text-green-600" />
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    {subscriptionTier === 'starter' ? 
                      ...
                      'Detailed analytics for your client interactions'}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-8">
                    {/* Basic Analytics - For all plans */}
                    <div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <Card>
                            ...
                            <CardContent className="h-[200px] flex items-center justify-center bg-gray-50 rounded-md">
                              <p className="text-muted-foreground">Client engagement chart would appear here</p>
                            </CardContent>
                          </Card>
                          <Card>
                            <CardHeader className="pb-2">
                              <CardTitle className="text-sm font-medium">Ticket Resolution Time</CardTitle>
                            </CardHeader>
                            <CardContent className="h-[200px] flex items-center justify-center bg-gray-50 rounded-md">
                    ...
                    {subscriptionTier === 'enterprise' && (
                      <div>
                        ...
                        <Card className="bg-indigo-50 border-indigo-100">
                          <CardHeader>
                            <CardTitle className="text-indigo-800 text-lg">Client Behavior Analysis</CardTitle>
                          </CardHeader>
                          <CardContent className="space-y-4">
                            <p>
                              Our AI has analyzed your client interactions and identified the following patterns:
                            </p>
                            <ul className="space-y-2">
                              <li className="flex items-start gap-2">
                                <div className="bg-indigo-200 text-indigo-700 rounded-full p-1 mt-0.5">
                                  <Check className="h-3 w-3" />
                                </div>
                                <span>Clients are most responsive on Tuesday and Wednesday mornings</span>
                              </li>
                              <li className="flex items-start gap-2">
                                <div className="bg-indigo-200 text-indigo-700 rounded-full p-1 mt-0.5">
                                  <Check className="h-3 w-3" />
                                </div>
                                <span>60% of support requests are related to account settings</span>
                              </li>
                              <li className="flex items-start gap-2">
                                <div className="bg-indigo-200 text-indigo-700 rounded-full p-1 mt-0.5">
                                  <Check className="h-3 w-3" />
                                </div>
                                <span>Clients who engage weekly are 3x more likely to renew</span>
                              </li>
                            </ul>
                            <Button className="w-full">View Complete Analysis</Button>
                          </CardContent>
                        </Card>
                      </div>
                    )}
                    ...
                    {subscriptionTier === 'starter' && (
                      <Card className="bg-blue-50 border-blue-100">
                        ...
                        <CardContent className="space-y-4">
                          <p>
                            Upgrade to Professional or Enterprise plan to access:
                          </p>
                          <ul className="space-y-2">
                            <li className="flex items-center gap-2">
                              <Check className="h-5 w-5 text-green-600" />
                            ...
                            <li className="flex items-center gap-2">
                              <Check className="h-5 w-5 text-green-600" />
                              <span>Client engagement tracking</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <Check className="h-5 w-5 text-green-600" />
                            ...
                            <li className="flex items-center gap-2">
                              <Check className="h-5 w-5 text-green-600" />
                              <span>AI-powered insights (Enterprise)</span>
                            </li>
                          </ul>
                          <Button
                            className="w-full"
            ...
            {/* Automation Tab - Pro & Enterprise Only */}
              ...
              {subscriptionTier !== 'starter' ? (
                <>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Automate routine tasks and client interactions
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <Card>
                          ...
                          <CardContent>
                            <div className="text-3xl font-bold">18hr</div>
                            <p className="text-xs text-green-600 mt-1">
                              This month
                            </p>
                          </CardContent>
                      ...
                      <div>
                        <h3 className="text-lg font-medium mb-4">Active Workflows</h3>
                        <div className="rounded-md border">
                          <Table>
                            <TableHeader>
                              <TableRow>
                            ...
                            <TableBody>
                              <TableRow>
                                ...
                                <TableCell>New Client Added</TableCell>
                                <TableCell>
                              ...
                              <TableRow>
                                <TableCell className="font-medium">Ticket Assignment</TableCell>
                                <TableCell>New Ticket Created</TableCell>
                                <TableCell>
                                  <Badge className="bg-green-500">Active</Badge>
                                </TableCell>
                              ...
                              <TableRow>
                                <TableCell className="font-medium">Follow-up Reminder</TableCell>
                                <TableCell>Ticket Inactive for 3 Days</TableCell>
                                <TableCell>
                                  <Badge className="bg-green-500">Active</Badge>
                                </TableCell>
                              ...
                              <TableRow>
                                ...
                                <TableCell>Schedule (First of Month)</TableCell>
                                <TableCell>
                                  <Badge className="bg-green-500">Active</Badge>
                                </TableCell>
                                <TableCell>26 days ago</TableCell>
                                <TableCell className="text-right">
                                  <Button variant="ghost" size="sm">
                                    <MoreVertical className="h-4 w-4" />
                                  </Button>
                              ...
                              <TableRow>
                                <TableCell 
                                  colSpan={5} 
                                  className={`text-center py-4 ${subscriptionTier === 'professional' ? 'bg-blue-50' : ''}`}
                                >
                                  {subscriptionTier === 'professional' ? (
                                    <div className="flex flex-col items-center">
                                      <p className="text-muted-foreground mb-2">
                                        Professional plan allows up to 5 automation workflows
                                      </p>
                                      <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => window.location.href = '/subscriptions'}
                                      >
                                        Upgrade to Enterprise for unlimited workflows
                                      </Button>
                                    </div>
                                  ) : (
                                    <Button>
                      ...
                      {/* Enterprise Only - AI Automation */}
                      {subscriptionTier === 'enterprise' && (
                        <Card className="bg-gradient-to-r from-indigo-50 to-blue-50 border-indigo-100">
                          <CardHeader>
                            <CardTitle className="text-indigo-800">AI Automation Suite</CardTitle>
                            <CardDescription>
                              Intelligent automation powered by our advanced AI
                            </CardDescription>
                          </CardHeader>
                          <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <Button variant="outline" className="h-auto flex flex-col items-center justify-center py-4 bg-white/80">
                                <div>
                                  <p className="font-medium">Predictive Client Outreach</p>
                                  <p className="text-xs text-muted-foreground mt-1">
                                    AI identifies when clients need attention
                                  </p>
                                </div>
                              </Button>
                              <Button variant="outline" className="h-auto flex flex-col items-center justify-center py-4 bg-white/80">
                                <div>
                                  <p className="font-medium">Smart Ticket Routing</p>
                                  <p className="text-xs text-muted-foreground mt-1">
                                    AI assigns tickets based on content and priority
                                  </p>
                                </div>
                              </Button>
                              <Button variant="outline" className="h-auto flex flex-col items-center justify-center py-4 bg-white/80">
                                <div>
                                  <p className="font-medium">Auto-Response Generation</p>
                                  <p className="text-xs text-muted-foreground mt-1">
                                    AI drafts contextual responses for approval
                                  </p>
                                </div>
                              </Button>
                              <Button variant="outline" className="h-auto flex flex-col items-center justify-center py-4 bg-white/80">
                                <div>
                                  <p className="font-medium">Client Behavior Analysis</p>
                                  <p className="text-xs text-muted-foreground mt-1">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Automate routine tasks with our workflow builder
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="py-10">
                    <div className="text-center space-y-4 max-w-md mx-auto">
                      ...
                      <p className="text-muted-foreground">
                        Automation features are available in the Professional and Enterprise plans.
                      </p>
                      <div className="space-y-2 pt-4">
                        <div className="flex items-center gap-2">
                          <Check className="h-5 w-5 text-green-600" />
                          <span>Create custom workflows</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Check className="h-5 w-5 text-green-600" />
                          <span>Automate client communications</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Check className="h-5 w-5 text-green-600" />
                          <span>Set up ticket routing rules</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Check className="h-5 w-5 text-green-600" />
                          <span>Schedule reports and alerts</span>
                        </div>
                      </div>
                      <Button 
