      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Healthcare Website Integration</h1>
              <p className="text-gray-500">Connect your healthcare systems with ConneqtCentral</p>
            </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="md:w-1/2">
                      ...
                      <div className="border rounded-lg p-4 bg-white h-[300px] relative">
                        <div className="absolute bottom-4 right-4 bg-blue-600 text-white p-3 rounded-full shadow-lg">
                          <MessageSquare className="w-6 h-6" />
                        </div>
                        <div className="bg-white shadow-lg rounded-lg p-4 max-w-[250px] absolute bottom-20 right-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-gray-100 p-4 rounded-md flex justify-between items-center">
                      <div>
                        ...
                        <div className="text-xs text-gray-500 mt-1">Created: April 12, 2025</div>
                      </div>
